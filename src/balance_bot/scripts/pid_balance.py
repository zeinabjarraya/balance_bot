...
class CascadePIDBalanceBot:
    def __init__(self):
        ...
        self.max_desired_pitch = math.radians(10)  # ±10°
    ...
    def imu_callback(self, msg):
        ...
        # ✅ Use gyro rate about X-axis if your wheels rotate about X.
        # IMPORTANT: Match this with your URDF joint axis!
        ...
        try:
            ...
            rospy.logerr("IMU calculation overflow! Skipping this cycle.")
            return
